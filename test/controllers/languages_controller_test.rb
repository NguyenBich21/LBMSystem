...
class LanguagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create language" do
    assert_difference("Language.count") do
      post languages_url, params: { language: { language: @language.language, language_id: @language.language_id } }
    end
  ...
  test "should update language" do
    patch language_url(@language), params: { language: { language: @language.language, language_id: @language.language_id } }
